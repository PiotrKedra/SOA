 ...
 * 
 */
@WebServiceClient(name = "StudentServiceService", targetNamespace = "http://helloG/", wsdlLocation = "http://localhost:8080/helloA-ejb/StudentService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName STUDENTSERVICESERVICE_QNAME = new QName("http://helloG/", "StudentServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/helloA-ejb/StudentService?wsdl");
    ...
    public StudentService getStudentServicePort() {
        return super.getPort(new QName("http://helloG/", "StudentServicePort"), StudentService.class);
    }
    ...
    public StudentService getStudentServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://helloG/", "StudentServicePort"), StudentService.class, features);
    }
